...
Contains:
- `yolo_node`: subscribes to `/atlas/rgbd_camera/image`, runs YOLOv8 inference, publishes `/yolo/detections` (JSON string) and `/yolo/dbg_image` (annotated Image)
...
Defaults assume model at `/home/somto/ros2_coursework_ws/results/trafficsignv3/weights/best.pt`.
